...
frisby.create('Testing User Registration')
    .post('https://tk-test-frisby-alex-baker.c9users.io/api/SSFUsers', {
        firstName: userModel,
        lastName: userModel ,
    ...
    .after(function(err, res, body){
        ...
        frisby.create('Delete created test user')
            .post('https://tk-test-frisby-alex-baker.c9users.io/api/SSFUsers/login', {
            email: userModel + "@" + userModel + ".com" ,
            password: userModel
            })
            .expectStatus(200)
            .afterJSON(function(user){
                ...
                frisby.create('deleting registered model now')
                    .delete('https://tk-test-frisby-alex-baker.c9users.io/api/SSFUsers/' + user.userId + '?access_token=' + user.id)
                    .expectStatus(200)
                .toss();
